...
association_table = Table('association', Base.metadata,
    Column('id_item_fk', Integer, ForeignKey('item.id_item')),
    Column('id_relacion_fk', Integer, ForeignKey('relacion.id_relacion'))
)
...
class Item(DeclarativeBase):
	...
	children = relationship("Relacion", secondary=association_table, backref="item")
